...
import { getFindByBrand } from '../services/CarService';
...
import ModelDataProvider from '../components/ModelDataProvider';
...
const Models = (props: ModelsProps) => {
  ...
  const split: string[] = location.pathname.split('/');
  const brand: string = split[3];
  const data: any = [];
