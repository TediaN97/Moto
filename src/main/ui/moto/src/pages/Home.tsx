...
const Home: React.FC<HomeProps> = ({data}) => {
  ...
  return (
    <div className="m-0 p-0 box-border flex flex-col min-h-screen font-rowdies font-light bg-purple text-dark-purple">
        <Header name="MOTOWIKI"/>
            ...
            <div>
                    <Slider data={data} searchValue={searchValue} filteredCountry={filteredCountry} />
            </div>
        <Footer/>
    </div>
  );
